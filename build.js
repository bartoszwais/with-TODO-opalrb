...
Opal.modules["application-todo"] = function(Opal) {
  ...
  Opal.add_stubs(['$find', '$new', '$add_class', '$html', '$on', '$prevent', '$puts', '$append', '$animate', '$html=', '$value', '$remove', '$value=']);
  return (function($base, $super) {
    function $TODO(){};
    ...
    return (def.$initialize = function() {
      var $a, $b, TMP_1, $c, TMP_2, $d, TMP_3, self = this, list = nil, form = nil, text_box = nil, button_send_list_to_email = nil;
...
if (event == null) event = nil;
      ...
      ($a = ($c = $scope.get('Element').$find(".dot")).$on, $a.$$p = (TMP_2 = function(event){var self = TMP_2.$$s || this;
if (event == null) event = nil;
      event.$prevent();
        return $scope.get('Element').$find(".dot").$animate($hash2(["right"], {"right": "80%"}));}, TMP_2.$$s = self, TMP_2), $a).call($c, "click");
      return ($a = ($d = form).$on, $a.$$p = (TMP_3 = function(event){var self = TMP_3.$$s || this, $a, $b, TMP_4, $c, item = nil;
if (event == null) event = nil;
      event.$prevent();
        item = $scope.get('Element').$new("div.row");
        (($a = ["<div class='card'><p>" + (text_box.$value()) + "</p></div>"]), $b = item, $b['$html='].apply($b, $a), $a[$a.length-1]);
        ($a = ($b = item).$on, $a.$$p = (TMP_4 = function(){var self = TMP_4.$$s || this;

        return item.$remove()}, TMP_4.$$s = self, TMP_4), $a).call($b, "click");
        list.$append(item);
        return (($a = [""]), $c = text_box, $c['$value='].apply($c, $a), $a[$a.length-1]);}, TMP_3.$$s = self, TMP_3), $a).call($d, "submit");
    }, nil) && 'initialize'
  })(self, null)
};
...
(function(Opal) {
  ...
  Opal.add_stubs(['$require', '$find', '$new', '$add_class', '$html=', '$append', '$ready?']);
  self.$require("opal");
  ...
  (function($base, $super) {
    ...
    return (def.$initialize = function() {
      var $a, $b, self = this, content = nil, active_dot = nil;
  ...
  $scope.get('Content').$new();
    return $scope.get('TODO').$new();}, TMP_1.$$s = self, TMP_1), $a).call($b);
})(Opal);
